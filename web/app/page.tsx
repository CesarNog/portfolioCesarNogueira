        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-4">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href={siteConfig.links.github} target="_blank" rel="noreferrer" aria-label="GitHub" className="text-[var(--color-fg-muted)] transition-colors hover:text-[var(--color-fg)]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <a href={siteConfig.links.x} target="_blank" rel="noreferrer" aria-label="X (Twitter)" className="text-[var(--color-fg-muted)] transition-colors hover:text-[var(--color-fg)]">
