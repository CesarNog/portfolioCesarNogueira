...
const es: Dict = {
  ...
  recruiterPrompts: [
    ...
    "¿Qué impacto de negocio ha generado Cesar?",
    ...
    "Mostrar experiencia de liderazgo",
    "Mostrar proyectos empresariales",
    "Mostrar experiencia en IA y automatización",
    "Mostrar trabajo de consultoría internacional",
  ],
  story: {
...
const fr: Dict = {
  ...
  recruiterPrompts: [
    ...
    "Quel impact business Cesar a-t-il généré ?",
    "Voir l'expérience en architecture cloud",
    "Voir les réalisations FinOps",
    "Voir l'expertise Kubernetes",
    "Voir les certifications GCP",
    "Voir l'expérience en leadership",
    "Voir les projets entreprise",
    "Voir l'expérience IA et automatisation",
    "Voir le travail de conseil international",
  ],
  story: {
