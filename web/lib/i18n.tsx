...
const pt: Dict = {
  ...
  labels: {
    ...
    aiFaqNote: "// O Smart AI FAQ neste site é uma integração de IA — pergunte tudo sobre a adequação do Cesar ao seu cargo.",
  },
};
...
const es: Dict = {
  ...
  labels: {
    ...
    aiFaqNote: "// El Smart AI FAQ de este sitio es una integración de IA — pregúntale cualquier cosa sobre el perfil de Cesar.",
  },
};
...
const fr: Dict = {
  ...
  labels: {
    ...
    aiFaqNote: "// Le Smart AI FAQ sur ce site est une intégration IA — posez-lui n'importe quelle question sur le profil de Cesar.",
  },
};
...
const zh: Dict = {
  ...
  labels: {
    ...
    architecture: "架构",
    businessResult: "业务成果",
    aiFaqNote: "// 本站的智能AI FAQ是一个AI集成——向它询问任何关于Cesar是否适合您职位的问题。",
  },
};
