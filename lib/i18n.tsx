...
const pt: Dict = {
  ...
  capabilities: [
    ...
    { area: "Engenharia de Plataformas",level: "Especialista",      note: "Golden paths, plataformas self-service e Kubernetes à escala." },
    { area: "DevOps & CI/CD",           level: "Especialista",      note: "Design de pipelines e automação de entrega do início ao fim." },
    { area: "FinOps",                   level: "Especialista",      note: "Otimização de custos, etiquetagem, chargeback e previsão que remove desperdício real." },
    { area: "Infraestrutura como Código",level: "Especialista",     note: "Infraestrutura reproduzível e revisável em múltiplas clouds." },
    { area: "Observabilidade",          level: "Especialista",      note: "Monitorização 24/7, on-call e ferramentas de incidente para sistemas críticos." },
...
const es: Dict = {
  ...
  projects: {
    ...
    "bigdata-platform": {
      ...
      metricLabel: "rendimiento analítico",
    },
    "banking-cloud": {
...
const zh: Dict = {
  ...
  capabilities: [
    ...
    { area: "FinOps",         level: "专家",      note: "成本优化、标签管理、成本分摊与预测，消除真实浪费。" },
