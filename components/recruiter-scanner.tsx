            ...
            <div className="w-full max-w-lg">
              ...
              <div className="mb-8 rounded-lg border border-[var(--color-hairline)] bg-[var(--color-surface-1)] p-5 font-mono">
                ...
                <div className="mt-3 border-t border-[var(--color-hairline)] pt-3">
                  ...
                  <p className="mt-1 flex items-center gap-1 text-[10px] text-[var(--color-fg-subtle)]">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="shrink-0">
